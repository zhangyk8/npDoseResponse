...
More details can be found in :doc:`Methodology <method>` and the reference papers [1,2]_. Some tutorials for using **npDoseResponse** can be found in :doc:`Example 1: Single Confounder Model <Example_Single_Conf>`, :doc:`Example 2: Nonlinear Effect Model <Example_Nonlinear_Effect>`, and :doc:`Examples 3 and 4: RA, IPW, DR Estimations of Dose-Response Curve and its Derivative <Example_DR_Est>`.
