...
More details can be found in :doc:`Methodology <method>` and the reference paper [1]_. A tutorial for using **npDoseResponse** can be found in :doc:`Example <Example_npDoseResponse>`.
