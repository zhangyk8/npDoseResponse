...
More details can be found in :doc:`Methodology <method>` and the reference paper [1]_. Some tutorials for using **npDoseResponse** can be found in :doc:`Example 1: Single Confounder Model <Example_Single_Conf>` and :doc:`Example 2: Nonlinear Effect Model <Example_Nonlinear_Conf>`.
