...
and traditional regression adjustment estimator under the nonlinear effect model.
"""
...
for n in [500, 1000, 2000, 5000]:
    ...
    if job_id == 1:
        with open('./Results_New/Nonlinear_Eff_Bootstrap_'+str(job_id)+'_new_bw_n'+str(n)+'.dat', "wb") as file:
